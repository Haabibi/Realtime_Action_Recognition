...
print("model epoch {} best prec@1: {}".format(rgb_checkpoint['epoch'], checkpoint['best_prec1']))
print("model epoch {} best prec@1: {}".format(of_checkpoint['epoch'], checkpoint['best_prec1']))
...
for i, (data) in data_gen:
    ...
    print("this is video_pred: ", video_pred)
    for pred_num in video_pred:
        print(pred_num, index_dict[pred_num])
