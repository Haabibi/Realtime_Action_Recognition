...
if __name__=="__main__":
    ...
    for video in data_loader: 
        ...
        while(cap.isOpened()):
            ...
            if ret == True:
                ...
                print("[output length]: ", len(output), "how long it took to infer one video: ", inf_toc-inf_tic, "flow extraction avg: ", accu_flow_toc/num_frames)
                num_frames = 0
                accumulated_latency += inf_toc-inf_tic
                break 
    video_pred = [np.argmax(np.mean(x[0], axis=0)) for x in output]
    print(video_pred, video_labels)
    ...
    print(accumulated_latency/counter)
